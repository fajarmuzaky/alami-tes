...
public abstract class BaseSpecification<T> implements Specification<T> {
    ...
    protected final List<SearchCriteria> list;

    public BaseSpecification(BaseFilter baseFilter) {
        list = new ArrayList<>();
        this.setCriteriaList(baseFilter);
    }

    protected abstract void setCriteriaList(BaseFilter baseFilter);
